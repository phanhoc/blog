...
Example:
	gaiad testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2 --node-name hanoi
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "blogd", "Home directory of the node's daemon configuration")
